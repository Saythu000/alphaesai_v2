...
import { Database, Cpu, Target, Brain, Lock, ArrowRight, Activity, CheckCircle2, Zap, X } from "lucide-react";
...
const ARCH_NODES: NodeDetail[] = [
  {
    id: "ingestion",
    title: "Data Ingestion & Analytics",
    subtitle: "Enterprise Data ETL & Stream Processing",
    badge: "STAGE 01",
    icon: Database,
    stack: ["Databricks Delta Lake", "Snowflake", "Google BigQuery", "Apache Spark", "Kafka"],
    metrics: [
      { label: "Throughput", value: "2.4 GB/sec" },
      { label: "ETL Latency", value: "< 14ms" },
      { label: "Data Validation", value: "100% Automated" },
    ],
    description: "Connects structured SQL databases, cloud data warehouses, and unstructured streaming data into unified, sanitized analytical stores.",
    security: "TLS 1.3 encrypted in-transit, column-level access controls, zero plaintext caching.",
  },
  {
    id: "finetuning",
    title: "AI Model Fine-Tuning & GPU",
    subtitle: "Distributed Base Model Customization",
    badge: "STAGE 02",
    icon: Cpu,
    stack: ["PyTorch", "Hugging Face", "vLLM", "NVIDIA H100 Cluster", "LoRA / QLoRA"],
    metrics: [
      { label: "Training Speedup", value: "4.8x" },
      { label: "GPU Memory Efficiency", value: "94.2%" },
      { label: "Checkpoint Sync", value: "Real-time" },
    ],
    description: "Adapts foundation LLMs and domain-specific AI models on proprietary enterprise data with optimized quantization and gradient accumulation.",
    security: "Isolated VPC GPU clusters, confidential computing enclaves, cryptographic weight signing.",
  },
  {
    id: "rlhf",
    title: "RLHF & Data Curation",
    subtitle: "Human-in-the-Loop & DPO Alignment",
    badge: "STAGE 03",
    icon: Target,
    stack: ["DPO (Direct Preference)", "Reward Modeling", "Expert Human Annotation", "Red-Teaming"],
    metrics: [
      { label: "Consensus Accuracy", value: "99.4%" },
      { label: "Hallucination Reduction", value: "-82%" },
      { label: "Safety Score", value: "99.9/100" },
    ],
    description: "Aligns AI responses with domain standards using reward modeling, RLHF, and automated adversarial red-teaming.",
    security: "Anonymized PII redaction before human review, strict audit logs, role-based review access.",
  },
  {
    id: "vector",
    title: "Vector Search & Knowledge DB",
    subtitle: "Semantic Retrieval & Hybrid RAG Engine",
    badge: "STAGE 04",
    icon: Brain,
    stack: ["Pinecone", "Qdrant", "Neon Vector Extension", "LangChain", "LlamaIndex"],
    metrics: [
      { label: "Vector Search Time", value: "< 8ms" },
      { label: "Index Scale", value: "500M+ Vectors" },
      { label: "Retrieval Accuracy", value: "97.8%" },
    ],
    description: "Generates high-dimensional vector embeddings to enable instantaneous semantic search and contextual ground-truth retrieval for RAG pipelines.",
    security: "Tenant-isolated vector collections, encrypted index shards, dynamic metadata filtering.",
  },
  {
    id: "gateway",
    title: "Secure API & Analytics Gateway",
    subtitle: "Production Inference & Real-Time Telemetry",
    badge: "STAGE 05",
    icon: Lock,
    stack: ["vLLM Server", "TensorRT-LLM", "OpenAI Protocol", "Rate Limiter", "Telemetry Dashboard"],
    metrics: [
      { label: "P99 Response Latency", value: "18ms" },
      { label: "SLA Availability", value: "99.99%" },
      { label: "Active Guardrails", value: "24/7 Monitored" },
    ],
    description: "Exposes ultra-low-latency API endpoints guarded by real-time prompt injection detectors, rate limiters, and automated telemetry.",
    security: "SOC-2 Type II audit logging, token bucket rate limiting, automated DDoS mitigation.",
  },
];

export function HubSpokeArchitecture() {
  const [activeNode, setActiveNode] = useState<NodeDetail>(ARCH_NODES[0]);
  const [selectedModalNode, setSelectedModalNode] = useState<NodeDetail | null>(null);
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          ...
          <h2 className="font-['Hanken_Grotesk'] text-3xl sm:text-4xl font-extrabold text-[#241913] mb-3">
            Interactive Enterprise AI & Data Analytics Pipeline
          </h2>
          <p className="font-['Inter'] text-base text-[#564336] max-w-2xl mx-auto">
            Click or hover any architectural node to inspect data processing stages, technology stack integrations, and latency metrics.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-xl bg-[#ff5722] text-white">
                  <selectedModalNode.icon className="w-6 h-6" />
                </div>
                <div>
